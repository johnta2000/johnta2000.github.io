...
function renderLineup(){el.page.innerHTML=`<iframe id="lineupFrame" class="lineup-frame" title="Lost Lands 2026 lineup" src="/lost-lands-2026-lineup/?rally=1"></iframe>`;lineupRefreshTimer=setInterval(refreshLineupState,15000)}
