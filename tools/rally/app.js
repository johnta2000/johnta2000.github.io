...
function renderLineup(){
  if(data.id===DEFAULT_EVENT){
    el.page.innerHTML=`<iframe id="lineupFrame" class="lineup-frame" title="Lost Lands 2026 lineup" src="/lost-lands-2026-lineup/?rally=1&v=20260910-header"></iframe>`;
