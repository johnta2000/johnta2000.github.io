...
const seedBuckets = [
  ...
  },
  {
    ...
    groups: [
      ...
      {
        id: "bonus-articles",
        title: "Business bonus articles",
        tasks: ["Ink Business Cash and Unlimited 100k bonus", "CSRB 200k bonus"],
      },
      {
  ...
  },
  {
    ...
    groups: [
      {
        id: "shared-reddit",
        title: "Business subreddits",
        tasks: [
          {
            title: "r/chase business post",
            tags: ["Business"],
            stages: ["Content prepared", "Content posted"],
          },
          {
            title: "r/nextcard business post",
            tags: ["Business"],
            stages: ["Content prepared", "Content posted"],
          },
        ],
    ...
    groups: [
      {
        ...
        tasks: [
          ...
          { title: "Renotify all subaffiliates about Business LTO updated launch date", tags: ["Business LTO"] },
        ],
      },
      {
        id: "partner-tracker",
...
function buildExport() {
  return {
    warRoom: "June 12, 2026 Business Cards Prep",
